...
<div class="padding">
    ...
    <form id=simform class="ui mini form" action="status.php" method="get">
        ...
        <div class="inline fields" style="margin-bottom: 25px; white-space: nowrap; ">
            <label style="font-size: 1.2em; margin-right: 1px; ">문제ID：</label>
            <div class="field"><input name="problem_id" style="width: 100px; " type="text"
                    value="<?php echo htmlspecialchars($problem_id, ENT_QUOTES) ?>"></div>
            ...
            <label style="font-size: 1.2em; margin-right: 1px; ">제출언어：</label>
            ...
            <label style="font-size: 1.2em; margin-right: 1px;margin-left: 10px; ">채점상태：</label>
            <select class="form-control" size="1" name="jresult" style="width: 110px;">
                ...
                <?php if (isset($_SESSION[$OJ_NAME . '_' . 'administrator']) || isset($_SESSION[$OJ_NAME . '_' . 'source_browser'])) {
                    ...
                    echo "<select id=\"appendedInputButton\" class=\"form-control\" name=showsim onchange=\"document.getElementById('simform').submit();\" style=\"width: 110px;\">
    ...
    <table id="result-tab" class="very basic center aligned table" style="white-space: nowrap; " id="table">
        <thead>
            <tr>
                ...
                <th>문제ID</th>
                <th>채점결과</th>
                <th class='hidden-xs'>메모리사용량</th>
                <th class='hidden-xs'>실행시간</th>
                <th>제출언어</th>
                <th class='hidden-xs'>코드길이</th>
                <th class='hidden-xs'>제출시간</th>
                <th class='hidden-xs'>채점서버</th>
            </tr>
        </thead>
        <tbody>
    ...
    <div style="margin-bottom: 30px; ">
        ...
        <div style="text-align: center; ">
            <div class="ui pagination menu" style="box-shadow: none; ">
                ...
                <a class="icon item" href="<?php echo "status.php?" . $str2 . "&top=" . $bottom . "&prevtop=$top"; ?>"
                    id="page_next">
                    다음 페이지
                </a>
            </div>
