    ...
    <div style="font-content">
        ...
        <table id="result-tab" class="ui very basic center aligned table">
            ...
            <tbody>
                <tr>
                    <th>채점 대기중</th>
                    <th style="white-space: normal";>코드가 제출되고 채점을 기다리고 있는 상태입니다. 대부분의 경우 조금만 기다리면 채점이 진행됩니다.</th>
                </tr>
                <tr>
                    <th>재채점 대기중</th>
                    <th style="white-space: normal";>채점 데이터가 갱신되어 재채점을 기다리고 있는 상태입니다.</th>
                </tr>
                <tr>
                    <th>컴파일중</th>
                    <th style="white-space: normal";>제출된 코드를 컴파일하는 중입니다.</th>
                </tr>
                <tr>
                    <th>채점중</th>
                    <th style="white-space: normal";>채점이 진행되고 있는 중입니다.</th>
                </tr>
                <tr>
                    <th>모두 맞음</th>
                    <th style="white-space: normal";>모든 채점 데이터에 대해서 정확한 답을 출력했다는 의미입니다.</th>
                </tr>
                <tr>
                    <th>출력형식 다름</th>
                    <th style="white-space: normal";>출력된 결과가 문제에서 출력해야하는 출력형식과 다르게 출력되었다는 의미입니다. 문제의 출력형식에서 요구하는 형식과 똑같아야 합니다. 답 출력 후 출력형식에는 없는 공백문자나 
                        줄 바꿈이 더 출력되지는 않았는지 확인해 보아야 합니다.</th>
                </tr>
                <tr>
                    <th>틀림</th>
                    <th style="white-space: normal";>틀린 답을 출력헸다는 의미입니다. 채점 시스템에 등록하는 채점 데이터들은 외부로 공개하지 않는 것이 일반적입니다. 제출한 코드가 틀린 답을 출력하는 경우가 어떤 경우일지 더
                        생각해 보아야 합니다.</th>
                </tr>
                <tr>
                    <th>시간제한 초과</th>
                    <th style="white-space: normal";>제한시간 이내에 답을 출력하지 못했다는 의미입니다. 좀 더 빠르면서도 정확한 결과를 출력하도록 소스 코드를 수정해야합니다.</th>
                </tr>
                <tr>
                    <th>메모리제한 초과</th>
                    <th style="white-space: normal";>제출한 프로그램이 제한된 메모리용량보다 더 많은 메모리을 사용했다는 의미입니다. 메모리를 더 적게 사용하는 코드로 수정해야합니다.</th>
                </tr>
                <tr>
                    <th>출력제한 초과</th>
                    <th style="white-space: normal";>제출한 프로그램이 제한된 출력량 이상으로 결과를 출력했다는 의미입니다. 대부분의 경우 무한 반복 실행 구조에 의해 발생합니다. 채점 시스템의 출력 제한 바이트 수는 1M
                        bytes 입니다.</th>
                </tr>
                <tr>
                    <th>실행중 에러</th>
                    <th style="white-space: normal";>제출한 프로그램이 실행되는 도중에 오류가 발생했다는 의미입니다. 예를 들어, 'segmentation fault(허용되지 않는 메모리 영역에 접근하는 경우: 배열 인덱스 초과
                ...
                <tr>
                    <th>컴파일 에러</th>
                    <th style="white-space: normal";>제출한 소스코드를 ANSI 표준(gcc/g++/gpc) 컴파일러로 컴파일하지 못했다는 의미입니다. 컴파일 오류 메시지가 아닌 오류 경고(warning)는 이 메시지를
