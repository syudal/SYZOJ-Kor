        ...
        <div class="row">
                    ...
                    <div class="">
                        <div class="column">
                            ...
                            <div class="ui bottom attached segment">
                                ...
                                <div style="width: 260px; height: 260px; margin-left: 15.5px; "><canvas
                                        style="width: 260px; height: 260px; " id="pie_chart"></canvas></div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="eleven wide column">
                <div class="ui grid">
                    <div class="row">
                        <div class="column">
                            <h4 class="ui top attached block header">기록</h4>
                            <div class="ui bottom attached segment">
                                ...
                                <?php if ($page > $pagemin || $page < $pagemax) {
