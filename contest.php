        ...
        <div class="row">
            <div class="column">
                <div class="ui buttons">
                    <a class="ui small blue button" href="contestrank.php?cid=<?php echo $view_cid ?>">ACM 차트로 보기</a>
                    <a class="ui small yellow button" href="contestrank-oi.php?cid=<?php echo $view_cid ?>">OI 차트로 보기</a>
                    <a class="ui small positive button" href="status.php?cid=<?php echo $view_cid ?>">채점기록</a>
                ...
                <div class="ui buttons right floated">
                    ...
                    <?php if (isset($_SESSION[$OJ_NAME . '_' . 'administrator']) || isset($_SESSION[$OJ_NAME . '_m' . $cid])) { ?>
                        <a href="suspect_list.php?cid=<?php echo $view_cid ?>" class="ui small blue button">
                            <?php echo $MSG_IP_VERIFICATION ?>
                        </a>
                        <a href="user_set_ip.php?cid=<?php echo $view_cid ?>" class="ui small green button">
            ...
            <div class="row">
                <div class="column">
                    <h4 class="ui top attached block header">
                        <?php echo $MSG_Contest_Infomation ?>
                    </h4>
                    ...
                    <thead>
                        <tr>
                            <th class="one wide" style="text-align: center">
                                ...
                                <th class="two wide" style="text-align: center">
